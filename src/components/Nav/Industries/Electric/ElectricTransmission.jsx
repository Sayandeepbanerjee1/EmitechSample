...
import Partners from "../../../Partner";
  ...
  const ElectricTransmission = () => {
    const tableData = [
        ...
        {
            link: 'https://www.esri.com/en-us/arcgis/products/arcgis-solutions/overview',
            linkText: 'Share an Improvement Schedule',
            imageSrc: 'http://solutions.arcgis.com/state-government/em-management/img/MyHazardInfo.png',
            imageAlt: 'Share an Improvement Schedule',
            description:
        ...
        {
            link: 'https://www.esri.com/en-us/arcgis/products/arcgis-solutions/overview',
            linkText: 'Improve Utility Maps',
            imageSrc: 'http://solutions.arcgis.com/state-government/em-management/img/MyHazardInfo.png',
            imageAlt: 'Improve Utility Maps',
            description:
