...
import Partners from "../../../Partner";
  ...
  const Intelligence = () => {
    const tableData = [
        {
            link: 'http://solutions.arcgis.com/gallery/#s=0&md=industries:defense:Intelligence',
            linkText: 'Intelligence',
            imageSrc: 'http://solutions.arcgis.com/assets/images/defense-isr.png',
