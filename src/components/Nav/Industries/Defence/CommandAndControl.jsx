...
import Partners from "../../../Partner";
  ...
  const CommandAndControl = () => {
    const tableData = [
        {
            link: 'http://solutions.arcgis.com/gallery/#s=0&md=industries:defense:Command%20and%20Control',
            linkText: 'Command and Control',
            imageSrc: 'http://solutions.arcgis.com/assets/images/defense-c2.png',
            imageAlt: 'Command and Control',
            description:
